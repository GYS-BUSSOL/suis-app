...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-barcode-partner': RouteRecordInfo<'apps-barcode-partner', '/apps/barcode/partner', Record<never, never>, Record<never, never>>,
    'apps-barcode-partner-approval': RouteRecordInfo<'apps-barcode-partner-approval', '/apps/barcode/partner/approval', Record<never, never>, Record<never, never>>,
    'apps-barcode-procurement': RouteRecordInfo<'apps-barcode-procurement', '/apps/barcode/procurement', Record<never, never>, Record<never, never>>,
    'apps-barcode-security': RouteRecordInfo<'apps-barcode-security', '/apps/barcode/security', Record<never, never>, Record<never, never>>,
    ...
    'apps-location': RouteRecordInfo<'apps-location', '/apps/location', Record<never, never>, Record<never, never>>,
